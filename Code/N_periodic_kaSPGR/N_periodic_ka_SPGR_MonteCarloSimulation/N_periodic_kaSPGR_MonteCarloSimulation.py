...
#Bloch simulation in C, provided by Zimu Huo 
import sys
...
##------------------------------------- Functions Section -------------------------------------------
###Calculate the phase shift for current TR (quadratic RF spoiling)
...
### N-periodic ka-SPGR (bSSFP + quadratic RF spoiling) - data simulation function
...
#Generate 2D matrix of:
#NPeriodData_0.05Noise_Bias.npy      ---> percentage bias
#NPeriodData_0.05Noise_Errorstd.npy  ---> standard deviation of 1000 samples
#NPeriodData_0.05Noise_Mean.npy      ---> mean T2* of 1000 samples
#NPeriodData_0.05Noise_ErrorMean.npy ---> mean of T2* difference from ground truth
#Further visualising see MonteCarloResultDisplay.ipynb
